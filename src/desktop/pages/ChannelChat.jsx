  ...
  const handleTaskQuickStatusChange = async (taskNumber, nextStatus) => {
    ...
    try {
      ...
      if (data?.success && data.task) {
        ...
        // Sidebar's pending-tasks badge listens for this in the same tab —
  ...
  return (
    ...
    <div className="w-full flex flex-col h-[100dvh] md:h-[calc(100vh-110px)] lg:h-[calc(100vh-80px)] bg-white">
      ...
      {channelUpdateModal && (
        ...
        >
          <div
            className="w-[90vw] sm:w-[520px] max-w-[520px] bg-white rounded-xl shadow-modal border border-gray-200 max-h-[90vh] overflow-y-auto"
